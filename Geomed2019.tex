...
number ($R_t$),Temperature, Humidity and Atmospheric presure.
\paragraph*{LSTM.}
...
series in the predictor matrix $X$.
\begin{equation}
...
Predictions where run from 2016 on since before this date Chikungunya and Zika 
