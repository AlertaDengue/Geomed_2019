...
conditional quantiles from high-dimensional predictors.
\section*{Results}

\noindent
Both models were fitted to available data yielding...

\begin{center}\vspace{1cm}
\includegraphics[width=0.85\linewidth]{figures/dcz_series.png}
...
\begin{center}\vspace{1cm}
\includegraphics[width=0.7\linewidth]{figures/dcz_series.png}
